...
public class Helper {
    ...
    public static List<StudentCourseEntity> excelToscEntityadvsup(InputStream is, StudentRepository studentRepository, CourseRepository courseRepository, StudentCourseRepository studentCourseRepositiry, Long sem, String type,String date,String regulation) {
    ...
    public static List<StudentEntity> studentExcelToDB(InputStream is,StudentRepository studentRepository) {
                ...
                while (cellsInRow.hasNext()) {
                    ...
                    switch (cellIdx) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            studentEntity.setBatchid(formatter.formatCellValue(currentCell));
                            break;
                        case 5:
